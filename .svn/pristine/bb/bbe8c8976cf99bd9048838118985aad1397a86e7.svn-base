...
//        HttpConnectionParams.setSoTimeout(httpParams, DEFAULT_SOCKET_TIMEOUT);
        ...
        sHttpClient.getCookieSpecs().register("http.protocol.cookie-policy", csf);
        sHttpClient.getParams().setParameter(ClientPNames.COOKIE_POLICY,
                "http.protocol.cookie-policy");
        sHttpClient.getParams()
    ...
    {
        System.out.println("-------------HttpManager HttpUriRequest post-------------");
        return sHttpClient.execute(post);
    }
            ...
            throws IOException
    {
        ...
        final HttpHost host = (HttpHost) sHttpClient.getParams()
                .getParameter(ConnRouteParams.DEFAULT_PROXY);
        if (host != null)
        {
            sHttpClient.getParams()
                    .removeParameter(ConnRouteParams.DEFAULT_PROXY);
        }
    ...
    {
        final HttpHost para = (HttpHost) sHttpClient.getParams()
                .getParameter(ConnRouteParams.DEFAULT_PROXY);
        if (para != null)
        {
            sHttpClient.getParams()
