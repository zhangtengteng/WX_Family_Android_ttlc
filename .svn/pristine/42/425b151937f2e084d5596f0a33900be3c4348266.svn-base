        ...
        PageIndicator
{
    ...
    */
    ...
    private void addTab(int index, CharSequence text, int iconResId)
    {
        ...
        if (iconResId != 0)
        {
            tabView.mImageView.setVisibility(View.VISIBLE);
            tabView.mImageView.setImageResource(iconResId);
        }
        else
        {
            tabView.mImageView.setVisibility(View.GONE);
        }
        //        if (index == 0)
        //        {
        tabView.mDividerView.setVisibility(View.GONE);
        //        }
        //        else
        //        {
        //            tabView.mDividerView.setVisibility(View.VISIBLE);
        //        }
    ...
    private class TabView extends LinearLayout
    {
        ...
        {
            super(context);
            inflate(context, R.layout.ysh_tab_view, this);
            mTextView = (TextView) findViewById(R.id.tab_textview);
            mDividerView = findViewById(R.id.tab_divider_line);
