...
public abstract class ViewAware implements ImageAware
{
    ...
    @Override
    public boolean setBackgroundResource(int resId)
    {
        if (Looper.myLooper() == Looper.getMainLooper())
        {
            View view = viewRef.get();
            if (view != null)
            {
                setBackgroundResourceInto(resId, view);
                return true;
            }
        }
        else
    ...
    protected abstract void setBackgroundResourceInto(int resId, View view);
}
