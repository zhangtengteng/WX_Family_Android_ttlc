...
public final class YshObservable
{
	 ...
	 * 观察者向量
	 */
	private Vector<YshObserver> obs;
	 ...
	 * @return    单例对象
	 */
	public synchronized static YshObservable getInstance()
	{
		if (instance == null)
		{
	...
	* 将一个观察者加到观察者列表上面。 
	*/
	public synchronized void addObserver(YshObserver o)
	{
		// 判空操作
		if (o == null || obs == null)
		{
	...
	* 将一个观察者对象从观察者列表上删除。 
	*/
	public synchronized void deleteObserver(YshObserver o)
	{
		// 判空操作
	...
	*/
	public void notifyObservers(Object arg)
	{
		...
		synchronized (this)
		{
			...
			{
				((YshObserver) obs.elementAt(i)).updateAnimal(arg);
			}
		}
	}
}