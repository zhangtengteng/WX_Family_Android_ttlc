...
public class SlidingMenu extends RelativeLayout
{
    ...
    public void setHomeCenterView(View view)
    {
        LayoutParams aboveParams = new LayoutParams(LayoutParams.FILL_PARENT,
                LayoutParams.FILL_PARENT);
        ...
        mScroller.startScroll(oldScrollX,
                mSlidingView.getScrollY(),
                -Util.dpToPixel(mContext, 200),
                mSlidingView.getScrollY(),
                duration);
        invalidate();
        mSlidingView.bringToFront();
    ...
    {
        if (null != mMenuView && null != mSlidingView)
        {
    ...
    {
        closeKeyboard();
        if (null != mDetailView && null != mSlidingView)
        {
    ...
    private void closeKeyboard()
    {
        ...
        View v = ((WXMainFragmentActivity) mContext).getCurrentFocus();
        if (v == null)
            return;
